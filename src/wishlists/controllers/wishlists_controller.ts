...
export class WishlistsController {
    ...
    constructor(@inject(TYPE.WishlistRepository) wishlistRepository: Repository<Wishlist>) {
    ...
    public async createWishlist(@requestBody() newWishlist: Wishlist) {
        return this._wishlistRepository.save(this._wishlistRepository.create(newWishlist));
    }
    @httpPatch('/:id')
    public async updateWishlist(@requestParam('id') idParam,
